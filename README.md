...
Saoml 流控系统可用于 Linux 环境下的流控相关学习与测试。本文档主要整理了基础安装流程、APP 工具生成方式、线路配置位置说明以及常见问题排查方向。
...
```bash
wget -O xsaoml https://raw.githubusercontent.com/xccxcc240/Saoml5/refs/heads/main/xsaoml
chmod +x xsaoml
./xsaoml
```
